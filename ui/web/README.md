...
Default: `classic`. To add a skin, create `src/skins/<name>/`, implement a root layout component, register it in `src/skins/registry.ts`, and add it to the `skinLayoutMap` in `src/App.vue`.
