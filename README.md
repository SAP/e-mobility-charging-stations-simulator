...
# HELP simulator_station_started 1 when the charging station is started, 0 otherwise.
# TYPE simulator_station_started gauge
simulator_station_started{hash_id="2f1a8c0e9d4b7a32"} 1
# HELP simulator_connector_status_info Connector status (one-hot).
