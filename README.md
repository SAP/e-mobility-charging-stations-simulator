...
| performanceStorage         |                                              | {<br />"enabled": false,<br />"type": "jsonfile",<br />"uri": "file:///performance/performanceRecords.json"<br />}                                                                                                            | {<br />enabled: boolean;<br />type: string;<br />uri: string;<br />}<br />where type can be 'jsonfile' or 'mongodb'                                                                                                                                                      | Performance storage configuration section:<br />- _enabled_: enable performance storage<br />- _type_: 'jsonfile' or 'mongodb'<br />- _uri_: storage uri                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
