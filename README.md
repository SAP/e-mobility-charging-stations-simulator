...
| finishingStatusDelay                                 |               | 0                                                                                                                                  | integer                                                                                                                                                                       | seconds to wait in Finishing (OCPP 1.6) / Occupied (OCPP 2.0.x) state after transaction stop before transitioning to Available. 0 = immediate Available (default behavior)                                                                   |
